...
%
%   Input Parameters:
%   - Y: training sequence of arbitrary length,###任意长度的序列
...
%             field H,
%   - numb: the number of burnin iterations,###开始阶段迭代次数
%   - nums: the number of samples to output,###输出的样本数量
%   - numi: the number of sampling, iterations between two samples,
%   - S0: is the initial assignment to the sequence.###序列的初始值
%
%   Output Parameters:
